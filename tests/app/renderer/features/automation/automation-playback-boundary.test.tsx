...
import { AutomationProvider, useAutomation } from '../../../../../app/renderer/features/automation/automation-context';
import type { PlaybackCommandPort } from '../../../../../app/renderer/contexts/playback/playback-context';
...
describe('automation playback boundary (#222)', () => {
  ...
  it('proves automation-context.tsx does not import direct playback slice hooks', () => {
    const filePath = path.resolve(__dirname, '../../../../../app/renderer/features/automation/automation-context.tsx');
