...
import { AppLayoutContent } from '../../../app/renderer/app-layout-content';
...
vi.mock('../../../app/renderer/hooks/use-app-menu', () => ({
  useAppMenu: mocks.useAppMenu,
}));

vi.mock('../../../app/renderer/features/workbench/app-toolbar', () => ({
  AppToolbar: () => <div data-testid="app-toolbar" />,
}));

vi.mock('../../../app/renderer/features/workbench/status-bar', () => ({
  StatusBar: () => <div data-testid="status-bar" />,
}));

vi.mock('../../../app/renderer/features/workbench/windows-inline-menu-bar', () => ({
  WindowsInlineMenuBar: ({ children }: { children: ReactNode }) => <div data-testid="menu-bar">{children}</div>,
}));

vi.mock('../../../app/renderer/workbench-screen-router', () => ({
