...
import { OverlayListItemBody } from '../../../../../app/renderer/screens/overlay-editor/overlay-list-item-body';
...
vi.mock('../../../../../app/renderer/hooks/use-media-proxy-map', () => ({
...
vi.mock('../../../../../app/renderer/components/display/thumbnail', async () => {
...
vi.mock('../../../../../app/renderer/screens/overlay-editor/screen-context', () => ({
