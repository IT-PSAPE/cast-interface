...
export function EmptyStatePanel({ glyph, title, description }: EmptyStatePanelProps) {
  return (
    <section className="grid h-full min-h-0 place-items-center p-6">
      <div className="grid max-w-md place-items-center gap-3 rounded-lg border border-primary bg-primary/50 px-8 py-10 text-center">
        <div className="grid h-16 w-16 place-items-center rounded-xl border border-primary bg-tertiary text-tertiary">
          {glyph}
        </div>
