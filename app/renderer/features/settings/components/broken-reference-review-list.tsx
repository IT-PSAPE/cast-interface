...
function BrokenReferenceRow({
  ...
  return (
    <div className="grid gap-3 rounded border border-border-primary bg-background-tertiary/25 p-3">
      <div className="grid gap-1">
        <div className="text-sm font-medium text-text-primary">{reference.source}</div>
