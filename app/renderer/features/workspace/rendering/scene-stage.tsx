...
export function SceneStage({ scene, editable = false, className = '', onDrop, onDragOver, emitFramesFps = null, onFrame, fixedViewport = null, onViewportChange }: SceneStageProps) {
  ...
  useEffect(() => {
    if (!emitFramesFps || !onFrame) return;
  ...
  }, [editor.stageRef, emitFramesFps, fixedViewport, onFrame, scene.height, scene.width, viewport.sceneOffsetX, viewport.sceneOffsetY, viewport.sceneScale]);
