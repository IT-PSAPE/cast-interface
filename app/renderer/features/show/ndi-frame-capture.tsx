...
import { SceneNodeMedia } from '../stage/scene-node-media';
import { SceneNodeShape } from '../stage/scene-node-shape';
import { SceneNodeText } from '../stage/scene-node-text';
import type { RenderNode } from '../stage/scene-types';
