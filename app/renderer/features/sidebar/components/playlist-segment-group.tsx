    ...
    <div className="group/segment mb-1">
      ...
      >
        ...
        <button
          ...
          aria-label={`Open ${segment.segment.name} menu`}
          className="h-5 w-5 rounded border border-transparent text-current opacity-0 transition-opacity group-hover/segment-header:opacity-100 group-focus-within/segment-header:opacity-100 hover:border-stroke"
        >
          ⋮
        </button>
      </div>
        ...
        return (
          <div key={entry.entry.id} className="group relative">
            ...
            <button
              ...
              aria-label={`Open ${entry.presentation.title} menu`}
